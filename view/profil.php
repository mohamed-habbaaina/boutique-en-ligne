...
<body>
    ...
    <div id="contact_form">
        ...
        <div class="buttonDiv">
            <button id="nameDisplayBtn">Name</button>
            <button id="contactDisplayBtn">Adress</button>
            <button id="pwdDisplayBtn">Password</button>
        </div>
        ...
        <div class="profilNameDisplay" id="profilNameDisplay">
            ...
            <form method="post" id="updateNameForm">
                ...
                <div id="submit_form">
                    <button type="submit" id="nameFormBtn">Update</button>
                </div>
            </form>
        </div>
        ...
        <div class="profilContactDisplay" id="profilContactDisplay">
            <form method="post" id="updateContactForm">
                ...
                <div id="submit_form">
                    <button type="submit" id="contactFormBtn">Update</button>
                </div>
            </form>
        </div>
        <div class="profilPwdDisplay" id="profilPwdDisplay">
            <form method="post" id="updatePwdForm">
                ...
                <div id="submit_form">
                    <button type="submit" id="pwdFormBtn">Update</button>
                </div>
            </form>
        </div>
    </div>
