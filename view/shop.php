...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="page">
                <button class="button-59 btn_suivant"><a href="shop.php?page=<?php echo $page +1 ?>" >Next Page >></a></button>
                <button class="button-59"><a href="shop.php?page=<?php echo $page -1 ?>"> << Previous Page</a></button>
            </div>
            <div class="filter">
